...
function fbNews(q){const C=q||"Global";return[
{title:`${C}: Central bank signals policy shift`,source:"Reuters",country:C,severity:"high",category:"economy",ago:"1h ago",impact:"Redirects global capital flows, affects bond yields.",people:"Mortgage and loan costs change for households.",tradeEffect:"Bond repricing; currency ±1.5%"},
{title:`${C}: Infrastructure spending package announced`,source:"Bloomberg",country:C,severity:"medium",category:"politics",ago:"2h ago",impact:"Fiscal expansion could lift GDP 0.3-0.6%.",people:"Construction and related sectors see new hires.",tradeEffect:"Materials ETFs +2-4%"},
{title:"AI adoption accelerates globally",source:"FT",country:"Global",severity:"medium",category:"economy",ago:"3h ago",impact:"AI reshaping labour markets and corporate margins.",people:"Routine jobs at risk; AI management roles growing.",tradeEffect:"Tech indices +2%; semiconductors outperform"},
{title:`${C}: Trade surplus widens on exports`,source:"AP",country:C,severity:"low",category:"trade",ago:"4h ago",impact:"Stronger trade balance boosts currency outlook.",people:"Export workers benefit from increased orders.",tradeEffect:"Local currency positive"},
{title:"Diplomatic talks ease regional tensions",source:"BBC",country:"Global",severity:"medium",category:"politics",ago:"5h ago",impact:"Risk premiums in energy fall.",people:"Lower energy prices ease utility bills.",tradeEffect:"Oil -1.2%; equities rally"},
{title:`${C}: Jobs data beats forecast`,source:"WSJ",country:C,severity:"low",category:"economy",ago:"6h ago",impact:"Tight labour market delays rate cuts.",people:"More job openings; wages rising.",tradeEffect:"Equities bullish"},
{title:"Cyber attack on critical infrastructure",source:"Reuters",country:"Global",severity:"critical",category:"cyber",ago:"8h ago",impact:"Exposes systemic energy and finance vulnerabilities.",people:"Possible utility disruptions.",tradeEffect:"Cybersecurity stocks surge"},
{title:"Nations agree new climate targets",source:"Guardian",country:"Global",severity:"medium",category:"politics",ago:"10h ago",impact:"Accelerates clean energy investment.",people:"Green jobs created; energy costs may rise short-term.",tradeEffect:"Renewables ETFs gain"},
];}
...
function fbIntel(t){const tg=t||"Global";return{threatLevel:"moderate",stabilityIndex:62,
summary:`${tg} security situation monitored. Multiple overlapping pressures. No immediate escalation but underlying tensions persist.`,
alerts:[{type:"political",level:"high",title:`${tg}: Political uncertainty elevated`,detail:"Electoral cycle creating policy uncertainty. Markets pricing governance risk."},{type:"economic",level:"high",title:"Inflation challenging monetary policy",detail:"CPI above target for third month. Rate path uncertain."},{type:"cyber",level:"medium",title:"State-linked cyber activity detected",detail:"Increased scanning of critical infrastructure. Known APT pattern."},{type:"military",level:"medium",title:"Regional exercises above baseline",detail:"Force readiness elevated. Diplomatic channels open."}],
activeConflicts:[`${tg} border tensions unresolved`,"Proxy conflict affecting trade"],
economicPressures:["Currency depreciation risk","Debt costs rising","Export competitiveness pressure"],
cyberThreats:["Infrastructure assessments ongoing","Ransomware targeting finance","Supply chain concerns"],
diplomaticAlerts:["Trade talks stalled","Summit postponed","Sanctions review underway"]};}
